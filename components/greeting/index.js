      ...
      .then((response) => {
        if (!response.hasError) {
          ...
          let friendlyError = {
            ...
            technical:
              response.value !== undefined ? response.value.toString() : '',
          };
          setError(() => {
            throw friendlyError;
          });
    ...
    <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
      <View style={props.styles.aoGameContainer}>
        <View style={props.styles.aoGameInnerContainer}>
          <Image
            style={props.styles.aoGreetingsImage}
            source={require('./img/ask-ouija-greetings-background.png')}
            resizeMode={'cover'}
          />
          <View style={props.styles.aoGameBar}>
            {currentStep === 'intro' ? (
              <>
                <Text style={props.styles.aoGameTitle}>{'Ask Ouija'}</Text>
                ...
                <TouchableOpacity
                  style={props.styles.aoPrimaryButton}
            ...
            {currentStep === 'create-or-join' ? (
              <>
                ...
                <View style={props.styles.aoOrDividerRow}>
                  ...
                  <Text style={props.styles.aoOrDividerText}>{'or'}</Text>
                  <View style={props.styles.aoOrDivider} />
                </View>
                ...
                <View style={props.styles.aoEnterCodeRow}>
                  <TextInput
                    style={props.styles.aoCodeTextbox}
                    placeholder="????"
                    value={gameCode}
            ...
            {currentStep === 'error-game-not-found' ? (
              <>
                ...
                <TouchableOpacity
                  style={props.styles.aoPrimaryButton}
                  onClick={() => setCurrentStep('create-or-join')}>
                  <Text style={props.styles.aoPrimaryButtonText}>
                    {'Go Back'}
                  </Text>
                </TouchableOpacity>
